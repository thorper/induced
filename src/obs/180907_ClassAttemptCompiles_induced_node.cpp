...
class CorrData
{
	...
	public:
		CorrData()
		{
			wind_pub_corr = nh.advertise<WindStamped>("wind_data_corrected",5);
...
int main(int argc, char** argv)
{
	...
	CorrData corr_wind;
	// Synchronizer<MySyncPolicy> sync(MySyncPolicy(100), CorrData::imu_sub, cCorrData::gpl_sub, CorrData::wind_sub);
	// sync.registerCallback(boost::bind(&CorrData::callback,this,_1, _2, _3));
